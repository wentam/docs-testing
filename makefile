GITHUB_PAGES_URL = "https://wentam.github.io/docs-testing/"
...
%.md: %.typ
	echo "<a href=\"$(GITHUB_PAGES_URL)/$<.html\" target=\"_blank\" rel=\"noopener noreferrer\">" > $@
	echo '  <picture>' >> $@
	echo '    <source media="(prefers-color-scheme: dark)" srcset="docs/typ-build/$<.svg">' >> $@
	echo '    <source media="(prefers-color-scheme: light)" srcset="docs/typ-build/$<.svg">' >> $@
